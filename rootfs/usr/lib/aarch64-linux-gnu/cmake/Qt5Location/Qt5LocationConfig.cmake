...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5Location" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Location_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Location_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Location_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Location)
    ...
    set(_Qt5Location_OWN_INCLUDE_DIRS "${_qt5Location_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5Location_install_prefix}/include/aarch64-linux-gnu/qt5/QtLocation")
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/aarch64-linux-gnu/qt5/QtLocation/5.12.8"
        "${_qt5Location_install_prefix}/include/aarch64-linux-gnu/qt5/QtLocation/5.12.8/QtLocation"
    )
    ...
    macro(_populate_Location_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Location_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Location_check_file_exists(${imported_location})
