...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5Charts" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Charts_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Charts_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Charts_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Charts)
    ...
    set(_Qt5Charts_OWN_INCLUDE_DIRS "${_qt5Charts_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5Charts_install_prefix}/include/aarch64-linux-gnu/qt5/QtCharts")
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/aarch64-linux-gnu/qt5/QtCharts/5.12.8"
        "${_qt5Charts_install_prefix}/include/aarch64-linux-gnu/qt5/QtCharts/5.12.8/QtCharts"
    )
    ...
    macro(_populate_Charts_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Charts_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Charts_check_file_exists(${imported_location})
